...
<body>
	...
	<form action = "updatePro.jsp">
		<table border="1" id="table">
			...
			<tr>
				<td>암호</td>
				<td><input type="password" name="passwd" ud="passwd" required="required"></td>
			</tr>
			<tr>
				<td>이름</td>
			...
			<tr>
				<td>전화번호</td>
				<td><input type = "text" name="tel" required="required" pattern="\d{2,3}-\d{3,4}-\d{4}" value="<%=member.getTel() %>"></td>
			</tr>
			<tr>
				<td>날짜</td><td><%=member.getReg_date() %></td>
			</tr>
			<tr>
